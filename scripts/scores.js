...
function add_scores(draw)
{
  ...
  draw.add_score( 53, {f:[0,3],e:[   ],p:[   ]},{y:[0,1],yy:[   ],r:[   ],yr:[   ]}) // "Group A"        Czech Republic", "Mexico"        );
  draw.add_score( 54, {f:[1,0],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group A"        "South Africa", "Korea Republic" );
  ...
  draw.add_score( 51, {f:[2,1],e:[   ],p:[   ]},{y:[1,2],yy:[   ],r:[   ],yr:[   ]}) // "Group B"         "Switzerland", "Canada"        );
  draw.add_score( 52, {f:[3,1],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group B"        Bosnia-Herzegovina", "Qatar"         );
  ...
  draw.add_score( 49, {f:[0,3],e:[   ],p:[   ]},{y:[1,2],yy:[   ],r:[   ],yr:[   ]}) // "Group C"            "Scotland", "Brazil"        );
  draw.add_score( 50, {f:[4,2],e:[   ],p:[   ]},{y:[0,3],yy:[   ],r:[   ],yr:[   ]}) // "Group C"             "Morocco", "Haiti"         );
  ...
  draw.add_score( 59, {f:[3,2],e:[   ],p:[   ]},{y:[0,1],yy:[   ],r:[   ],yr:[   ]}) // "Group D"              "Turkey", "United States" );
  draw.add_score( 60, {f:[0,0],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group D"            "Paraguay", "Australia"     );
  ...
  draw.add_score( 55, {f:[0,2],e:[   ],p:[   ]},{y:[2,1],yy:[   ],r:[   ],yr:[   ]}) // "Group E"             "Curacao", "Ivory Coast"   );
  draw.add_score( 56, {f:[2,1],e:[   ],p:[   ]},{y:[3,1],yy:[   ],r:[   ],yr:[   ]}) // "Group E"             "Ecuador", "Germany"       );
  ...
  draw.add_score( 57, {f:[1,1],e:[   ],p:[   ]},{y:[1,2],yy:[   ],r:[   ],yr:[   ]}) // "Group F"               "Japan", "Sweden"        );
  draw.add_score( 58, {f:[1,3],e:[   ],p:[   ]},{y:[0,0],yy:[   ],r:[   ],yr:[   ]}) // "Group F"             "Tunisia", "Netherlands"   );
  ...
  draw.add_score( 63, {f:[1,1],e:[   ],p:[   ]},{y:[3,4],yy:[   ],r:[   ],yr:[   ]}) // "Group G"               "Egypt", "Iran"          );
  draw.add_score( 64, {f:[1,5],e:[   ],p:[   ]},{y:[2,0],yy:[   ],r:[   ],yr:[   ]}) // "Group G"         "New Zealand", "Belgium"       );
  ...
  draw.add_score( 65, {f:[0,0],e:[   ],p:[   ]},{y:[1,3],yy:[   ],r:[   ],yr:[   ]}) // "Group H"          "Cape Verde", "Saudi Arabia"  );
  draw.add_score( 66, {f:[0,1],e:[   ],p:[   ]},{y:[3,1],yy:[   ],r:[1,0],yr:[   ]}) // "Group H"             "Uruguay", "Spain"         );
  ...
  draw.add_score( 42, {f:[3,0],e:[   ],p:[   ]},{y:[0,1],yy:[   ],r:[   ],yr:[   ]}) // "Group I"              "France", "Iraq"          );
  draw.add_score( 41, {f:[3,2],e:[   ],p:[   ]},{y:[0,0],yy:[   ],r:[   ],yr:[   ]}) // "Group I"              "Norway", "Senegal"       );
  draw.add_score( 61, {f:[1,4],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group I"              "Norway", "France"        );
  draw.add_score( 62, {f:[5,0],e:[   ],p:[   ]},{y:[2,2],yy:[   ],r:[0,1],yr:[   ]}) // "Group I"             "Senegal", "Iraq"          );
  ...
  draw.add_score( 43, {f:[2,0],e:[   ],p:[   ]},{y:[2,2],yy:[   ],r:[   ],yr:[   ]}) // "Group J"           "Argentina", "Austria"       );
  draw.add_score( 44, {f:[1,2],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group J"              "Jordan", "Algeria"       );
  draw.add_score( 69, {f:[3,3],e:[   ],p:[   ]},{y:[0,1],yy:[   ],r:[   ],yr:[   ]}) // "Group J"             "Algeria", "Austria"       );
  draw.add_score( 70, {f:[1,3],e:[   ],p:[   ]},{y:[3,0],yy:[   ],r:[   ],yr:[   ]}) // "Group J"              "Jordan", "Argentina"     );
  ...
  draw.add_score( 47, {f:[5,0],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group K"            "Portugal", "Uzbekistan"    );
  draw.add_score( 48, {f:[1,0],e:[   ],p:[   ]},{y:[2,1],yy:[   ],r:[   ],yr:[   ]}) // "Group K"            "Colombia", "Congo DR"      );
  draw.add_score( 71, {f:[0,0],e:[   ],p:[   ]},{y:[1,0],yy:[   ],r:[   ],yr:[   ]}) // "Group K"            "Colombia", "Portugal"      );
  draw.add_score( 72, {f:[3,1],e:[   ],p:[   ]},{y:[3,2],yy:[   ],r:[   ],yr:[   ]}) // "Group K"            "Congo DR", "Uzbekistan"    );
  ...
  draw.add_score( 45, {f:[0,0],e:[   ],p:[   ]},{y:[1,1],yy:[   ],r:[   ],yr:[   ]}) // "Group L"             "England", "Ghana"         );
  ...
  draw.add_score( 84, {f:[3,0],e:[   ],p:[   ]},{y:[0,1],yy:[   ],r:[   ],yr:[   ]}) // "Round of 32"              "1H", "2J"            );
  draw.add_score( 83, {f:[2,1],e:[   ],p:[   ]},{y:[1,2],yy:[   ],r:[   ],yr:[   ]}) // "Round of 32"              "2K", "2L"            );
  draw.add_score( 85, {f:[2,0],e:[   ],p:[   ]},{y:[0,2],yy:[   ],r:[   ],yr:[   ]}) // "Round of 32"              "1B", "3 E/F/G/I/J"   );
  ...
  draw.add_score( 98, {f:[2,1],e:[   ],p:[   ]},{y:[2,2],yy:[   ],r:[   ],yr:[   ]}) // "Quarterfinals"          "W 93", "W 94"          );
  draw.add_score( 99, {f:[1,1],e:[1,2],p:[   ]},{y:[1,0],yy:[   ],r:[   ],yr:[   ]}) // "Quarterfinals"          "W 91", "W 92"          );
  draw.add_score(100, {f:[1,1],e:[3,1],p:[   ]},{y:[3,0],yy:[0,1],r:[   ],yr:[   ]}) // "Quarterfinals"          "W 95", "W 96"          );
