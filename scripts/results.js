...
const RESULTS = new class {
  ...
  #get_team(game_info)
  {
    ...
    switch(game_info[0])
    {
      ...
      case "1":  {   return this.get_group_placing("Group "+game_info[1], 1).team; }
      case "2":  {   return this.get_group_placing("Group "+game_info[1], 2).team; }
...
//                     console.log("find 3rd for "+group1, group3);
                     return this.get_group_placing("Group "+group3, 3).team;  }
...
//    console.log("find group place", group, placing, this.#group_completed[group])
    return { completed: this.#group_completed[group], team: this.#group_data[group][placing-1] }
  }
  ...
  add_knockout_result(match_no, team_no_winner)
  {
    this.#ko_data[match_no].winner = team_no_winner  // 0,1,2, where 0 = no winner
    this.#update_match_results()   
  }
